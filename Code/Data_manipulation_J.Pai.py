...
# Merge ACCIDENT 2014-2018 and VEHICLE 2014-2018 by the key variables 'YEAR' and 'ST_CASE'
...
# Merge ACCIDENT-VEHICLE 2014-2018 and PERSON 2014-2018 by the key variables 'YEAR', 'ST_CASE', 'VEH_NO'
...
# VE_TOTAL==1:single vehicle crash; SEAT_POS==11:no need passengers' information
...
acc_veh_per_copy['VSURCOND_GROUP'] = acc_veh_per_copy['VSURCOND'].map(vsurcond_map)

# Group roadway grade
vprofile_map = {0:'NA', 1:'LEVEL', 2:'GRADE', 3:'GRADE', 4:'GRADE', 5:'GRADE', 6:'GRADE', 8:'NA', 9:'NA'}
acc_veh_per_copy['VPROFILE_GROUP'] = acc_veh_per_copy['VPROFILE'].map(vprofile_map)

# Group roadway alignment
valign_map = {0:'NA', 1:'STRAIGHT', 2:'CURVE', 3:'CURVE', 4:'CURVE', 8:'NA', 9:'NA'}
acc_veh_per_copy['VALIGN_GROUP'] = acc_veh_per_copy['VALIGN'].map(valign_map)
...
vehicle_type_map = {1:'CAR', 2:'CAR', 3:'CAR', 4:'CAR', 5:'CAR', 6:'CAR', 7:'CAR', 8:'CAR', 9:'CAR', 10:'NA', 12:'CAR', 
                    ...
                    29:'VAN', 30:'PICKUP', 31:'PICKUP', 32:'PICKUP', 34:'PICKUP', 39:'PICKUP', 40:'PICKUP', 42:'NA', 45:'NA', 
                    48:'NA', 49:'NA', 50:'NA', 51:'NA', 52:'NA', 55:'NA', 58:'NA', 59:'NA', 60:'NA', 61:'NA', 62:'NA', 63:'NA',
                    64:'NA', 65:'NA', 66:'NA', 67:'NA', 71:'NA', 72:'NA', 73:'NA', 78:'NA', 79:'NA', 80:'NA', 81:'NA', 82:'NA', 
                    83:'NA', 84:'NA', 85:'NA', 86:'NA', 87:'NA', 88:'NA', 89:'NA', 90:'NA', 91:'NA', 92:'NA', 93:'NA', 94:'NA', 
                    95:'NA', 96:'NA', 97:'NA', 98:'NA', 99:'NA'}
acc_veh_per_copy['VEHICLE_TYPE'] = acc_veh_per_copy['BODY_TYP'].map(vehicle_type_map)

# Group model year
condition1 = [
    (acc_veh_per_copy['MOD_YEAR'] >= 1923) & (acc_veh_per_copy['MOD_YEAR'] <= 2010),
...
model_year_value = ['1923-2010','2011-2019', 'NA', 'NA']
...
acc_veh_per_copy['GENDER'] = acc_veh_per_copy['SEX'].map(rollover_map)
...
project=acc_veh_per_copy[(acc_veh_per_copy.WEATHER_GROUP != 'NA') & 
                         ...
                         (acc_veh_per_copy.VSURCOND_GROUP != 'NA') &
                         (acc_veh_per_copy.VPROFILE_GROUP != 'NA') &
                         (acc_veh_per_copy.VALIGN_GROUP != 'NA') &
